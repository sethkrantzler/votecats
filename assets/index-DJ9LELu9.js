 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Vy="FirebaseError";class Ur extends Error{constructor(t,e,n){super(e),this.code=t,this.customData=n,this.name=Vy,Object.setPrototypeOf(this,Ur.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Fc.prototype.create)}}class Fc{constructor(t,e,n){this.service=t,this.serviceName=e,this.errors=n}create(t,...e){const n=e[0]||{},r=`${this.service}/${t}`,s=this.errors[t],o=s?ky(s,n):"Error",a=`${this.serviceName}: ${o} (${r}).`;return new Ur(r,a,n)}}function ky(i,t){return i.replace(By,(e,n)=>{const r=t[n];return r!=null?String(r):`<${n}?>`})}const By=/\{\$([^}]+)}/g;function cc(i,t){if(i===t)return!0;const e=Object.keys(i),n=Object.keys(t);for(const r of e){if(!n.includes(r))return!1;const s=i[r],o=t[r];if(sp(s)&&sp(o)){if(!cc(s,o))return!1}else if(s!==o)return!1}for(const r of n)if(!e.includes(r))return!1;return!0}function sp(i){return i!==null&&typeof i=="object"}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const r_="installations",NE="installations-internal",OE=i=>{const t=i.getProvider("app").getImmediate(),e=LE(t),n=Za(t,"heartbeat");return{app:t,appConfig:e,heartbeatServiceProvider:n,_delete:()=>Promise.resolve()}},UE=i=>{const t=i.getProvider("app").getImmediate(),e=Za(t,r_).getImmediate();return{getId:()=>PE(e),getToken:r=>IE(e,r)}};function FE(){Rr(new tr(r_,OE,"PUBLIC")),Rr(new tr(NE,UE,"PRIVATE"))}FE();wi(zg,Af);wi(zg,Af,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fc="analytics",VE="firebase_id",kE="origin",BE=60*1e3,zE="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",Cf="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uS{constructor(t){this.app=t}_delete(){return delete ya[this.app.options.appId],Promise.resolve()}}let ya={},_p=[];const vp={};let du="dataLayer",hS="gtag",yp,l_,xp=!1;function fS(){const i=[];if(Oy()&&i.push("This is a browser extension environment."),Fy()||i.push("Cookies are not available."),i.length>0){const t=i.map((n,r)=>`(${r+1}) ${n}`).join(" "),e=Kn.create("invalid-analytics-context",{errorInfo:t});Nn.warn(e.message)}}function dS(i,t,e){fS();const n=i.options.appId;if(!n)throw Kn.create("no-app-id");if(!i.options.apiKey)if(i.options.measurementId)Nn.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${i.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw Kn.create("no-api-key");if(ya[n]!=null)throw Kn.create("already-exists",{id:n});if(!xp){$E(du);const{wrappedGtag:s,gtagCore:o}=KE(ya,_p,vp,du,hS);l_=s,yp=o,xp=!0}return ya[n]=cS(i,_p,vp,t,yp,du,e),new uS(i)}function pS(i=Vg()){i=ys(i);const t=Za(i,fc);return t.isInitialized()?t.getImmediate():mS(i)}function mS(i,t={}){const e=Za(i,fc);if(e.isInitialized()){const r=e.getImmediate();if(cc(t,e.getOptions()))return r;throw Kn.create("already-initialized")}return e.initialize({options:t})}function gS(i,t,e,n){i=ys(i),aS(l_,ya[i.app.options.appId],t,e,n).catch(r=>Nn.error(r))}const Ep="@firebase/analytics",Sp="0.10.7";function _S(){Rr(new tr(fc,(t,{options:e})=>{const n=t.getProvider("app").getImmediate(),r=t.getProvider("installations-internal").getImmediate();return dS(n,r,e)},"PUBLIC")),Rr(new tr("analytics-internal",i,"PRIVATE")),wi(Ep,Sp),wi(Ep,Sp,"esm2017");function i(t){try{const e=t.getProvider(fc).getImmediate();return{logEvent:(n,r,s)=>gS(e,n,r,s)}}catch(e){throw Kn.create("interop-component-reg-failed",{reason:e})}}}_S();var Tp=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class y_{constructor(t,e){this.previousValue=t,e&&(e.sequenceNumberHandler=n=>this.ie(n),this.se=n=>e.writeSequenceNumber(n))}ie(t){return this.previousValue=Math.max(t,this.previousValue),this.previousValue}next(){const t=++this.previousValue;return this.se&&this.se(t),t}}y_.oe=-1;function If(i){return i==null}function pc(i){return i===0&&1/i==-1/0}function LS(i){return typeof i=="number"&&Number.isInteger(i)&&!pc(i)&&i<=Number.MAX_SAFE_INTEGER&&i>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class vc{constructor(t,e="asc"){this.field=t,this.dir=e}}function VS(i,t){return i.dir===t.dir&&i.field.isEqual(t.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tT=new Bn(ee.comparator);function yc(){return tT}const I_=new Bn(ee.comparator);function xl(...i){let t=I_;for(const e of i)t=t.insert(e.key,e);return t}function D_(i){let t=I_;return i.forEach((e,n)=>t=t.insert(e,n.overlayedDocument)),t}function os(){return Sa()}function L_(){return Sa()}function Sa(){return new $o(i=>i.toString(),(i,t)=>i.isEqual(t))}const eT=new Bn(ee.comparator),nT=new Sn(ee.comparator);function xn(...i){let t=nT;for(const e of i)t=t.add(e);return t}const iT=new Sn(_e);function rT(){return iT}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N_(i,t){if(i.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:pc(t)?"-0":t}}function O_(i){return{integerValue:""+i}}function sT(i,t){return LS(t)?O_(t):N_(i,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wc(i){return new _T(i,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aM{constructor(t,e,n,r,s){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.x_=[],this.O_=new Map,this.N_=new Set,this.L_=[],this.B_=s,this.B_.oo(o=>{n.enqueueAndForget(async()=>{nl(this)&&(Vt("RemoteStore","Restarting streams for network reachability change."),await async function(l){const c=ye(l);c.N_.add(4),await el(c),c.k_.set("Unknown"),c.N_.delete(4),await Xc(c)}(this))})}),this.k_=new oM(n,r)}}async function Xc(i){if(nl(i))for(const t of i.L_)await t(!0)}async function el(i){for(const t of i.L_)await t(!1)}function nl(i){return ye(i).N_.size===0}async function q_(i,t,e){if(!Bc(t))throw t;i.N_.add(1),await el(i),i.k_.set("Offline"),e||(e=()=>KT(i.localStore)),i.asyncQueue.enqueueRetryable(async()=>{Vt("RemoteStore","Retrying IndexedDB access"),await e(),i.N_.delete(1),await Xc(i)})}function j_(i,t){return t().catch(e=>q_(i,e,t))}async function $c(i){const t=ye(i),e=Ir(t);let n=t.x_.length>0?t.x_[t.x_.length-1].batchId:-1;for(;lM(t);)try{const r=await JT(t.localStore,n);if(r===null){t.x_.length===0&&e.s_();break}n=r.batchId,cM(t,r)}catch(r){await q_(t,r)}Y_(t)&&K_(t)}function lM(i){return nl(i)&&i.x_.length<10}function cM(i,t){i.x_.push(t);const e=Ir(i);e.n_()&&e.R_&&e.V_(t.mutations)}function Y_(i){return nl(i)&&!Ir(i).t_()&&i.x_.length>0}function K_(i){Ir(i).start()}async function uM(i){Ir(i).g_()}async function hM(i){const t=Ir(i);for(const e of i.x_)t.V_(e.mutations)}async function fM(i,t,e){const n=i.x_.shift(),r=Ff.from(n,t,e);await j_(i,()=>i.remoteSyncer.applySuccessfulWrite(r)),await $c(i)}async function dM(i,t){t&&Ir(i).R_&&await async function(n,r){if(function(o){return mT(o)&&o!==pt.ABORTED}(r.code)){const s=n.x_.shift();Ir(n).i_(),await j_(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await $c(n)}}(i,t),Y_(i)&&K_(i)}async function kp(i,t){const e=ye(i);e.asyncQueue.verifyOperationInProgress(),Vt("RemoteStore","RemoteStore received new credentials");const n=nl(e);e.N_.add(3),await el(e),n&&e.k_.set("Unknown"),await e.remoteSyncer.handleCredentialChange(t),e.N_.delete(3),await Xc(e)}async function pM(i,t){const e=ye(i);t?(e.N_.delete(2),await Xc(e)):t||(e.N_.add(2),await el(e),e.k_.set("Unknown"))}function Ir(i){return i.K_||(i.K_=function(e,n,r){const s=ye(e);return s.y_(),new rM(n,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,r)}(i.datastore,i.asyncQueue,{To:()=>Promise.resolve(),Ao:uM.bind(null,i),Vo:dM.bind(null,i),m_:hM.bind(null,i),f_:fM.bind(null,i)}),i.L_.push(async t=>{t?(i.K_.i_(),await $c(i)):(await i.K_.stop(),i.x_.length>0&&(Vt("RemoteStore",`Stopping write stream with ${i.x_.length} pending writes`),i.x_=[]))})),i.K_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
